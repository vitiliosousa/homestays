  ...
  return (
    <div className="flex w-4/5 gap-4 justify-between text-white py-10">
      ...
      <div className="h-[450px] w-[550px] rounded-xl relative overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-end p-10 text-center gap-2">
          <h1 className="text-3xl">Flights</h1>
          <p className="text-sm">
            Search flights & places Hire to our most popular destinations
          </p>
          <button className="text-xs bg-mint text-black flex font-semibold p-3 gap-1 rounded">
